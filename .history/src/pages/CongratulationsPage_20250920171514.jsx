          ...
          >
            {loading || !pokemon ? (
              ...
              <>
                ...
                />
                {/* --- FIX START --- */}
                {/* Increased z-index from z-10 to z-[202] to ensure text is on top of the image */}
                <div className="z-[202] text-left">
                  {/* --- FIX END --- */}
                  <h3 className="text-3xl font-bold text-white capitalize">
                    {formData.name || "Trainer"}
                  </h3>
                  <div className="mt-2">
                    <p className="text-xs text-blue-300">USN</p>
                    <p className="text-lg font-semibold text-white uppercase">
                      {formData.usn || "N/A"}
                    </p>
                  </div>
                  <div className="mt-2">
                    <p className="text-xs text-blue-300">Domain</p>
                    <p className="text-lg font-semibold text-white">
                      {domain.name}
                    </p>
                  </div>
