  ...
  const renderPage = () => {
    ...
    switch (page) {
      ...
      case "domainQuestions":
        return domain ? (
          <PageWrapper className={`${domain.theme.darkerBg} overflow-x-hidden`}>
            <DomainQuestionsPage
              domain={domain}
      ...
      case "domainForm":
        return domain ? (
          <PageWrapper className={`${domain.theme.darkerBg} overflow-x-hidden`}>
            <DomainFormPage domain={domain} onNavigate={handleNavigation} />
          </PageWrapper>
        ) : (
          <p>Error</p>
        );
      ...
      case "congratulations":
        return domain && formData ? (
          <PageWrapper className="bg-gray-200 overflow-x-hidden">
            <CongratulationsPage domain={domain} formData={formData} />
          </PageWrapper>
        ) : (
          <p>Error</p>
        );
